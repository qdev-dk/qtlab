...
_cfg = config.create_config('qtlibs.cfg')
_cfg.load_userconfig()
_cfg.setup_tempdir()

def _parse_options():
    import optparse
    parser = optparse.OptionParser(description='QTLibs')
    parser.add_option('--nogui', default=True, action='store_true')
    ...
    parser.add_option('--nolock', default=True, action='store_true')
