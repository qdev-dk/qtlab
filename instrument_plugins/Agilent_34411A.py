# Agilent_34411A.py class, for commucation with an Agilent 34411A multimeter
# Rasmus Skytte Eriksen <zrm439@alumni.ku.dk>, 2014
#
# Modified verison of: Agilent_34411A.py class
...
class Agilent_34411A(Instrument):
    '''
    This is the driver for the Agilent 34411A multimeter

    Usage:
    Initialize with
    <name> = qt.instruments.create('<name>', 'Agilent_34411A', address='<GBIP address>', reset=<bool>)
    '''

    def __init__(self, name, address, reset=False):
        '''
        Initializes the Agilent_34411A, and communicates with the wrapper.
        ...
        '''
        logging.info(__name__ + ' : Initializing instrument Agilent_34411A')
