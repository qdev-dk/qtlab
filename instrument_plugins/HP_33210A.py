# HP_33210A.py class, to perform the communication between the Wrapper and the device
# Rasmus Skytte Eriksen <zrm439@gmail.com>, 2014
# Based on the HP_33120A.py class of:
...
class HP_33210A(Instrument):
    '''
    This is the python driver for the HP 33210A
    arbitrary waveform generator

    Usage:
    Initialize with
    <name> = instruments.create('<name>', 'HP_33210A', address='<GPIB address>',
        reset=<bool>)
    '''
